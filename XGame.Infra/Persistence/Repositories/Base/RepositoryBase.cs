...
namespace XGame.Infra.Persistence.Repositories.Base
{
        ...
        where TId : struct
    {
        ...
        public IQueryable<TEntidade> ListarEOrdenadorPor<TKey>(Expression<Func<TEntidade, bool>> where, Expression<Func<TEntidade, TKey>> ordem, bool ascendente = true, params Expression<Func<TEntidade, object>>[] includeProperties)
        {
            return ascendente ? ListarPor(where, includeProperties).OrderBy(ordem) : ListarPor(where, includeProperties).OrderBy(ordem);
        }
        ...
        public IQueryable<TEntidade> ListarOrdenadorPor<TKey>(Expression<Func<TEntidade, TKey>> ordem, bool ascendente = true, params Expression<Func<TEntidade, object>>[] includeProperties)
        {
            return ascendente ? Listar(includeProperties).OrderBy(ordem) : Listar(includeProperties).OrderBy(ordem);
        }
        ...
        /// <summary>
        /// Adicionar uma Coleção de Entidades ao contexto do Entity Framework
        /// </summary>
        ...
        /// <summary>
        /// Realiza o Include populando o objeto passado por parametro
        /// </summary>
        /// <param name="query">Informa o objeto do Tipo IQuerable</param>
        /// <param name="includeProperties">Informa o Array de Expressões que deseja incluir</param>
        /// <returns></returns>
